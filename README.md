...
## Reproducible File
We have uploaded an Rmd file to reproduce all the results in the paper [False Discovery Rate Control via Data Splitting](https://arxiv.org/pdf/2002.08542.pdf). The knockoff. R and MBHq.R are used to compare our methods with other two methods for linear regression and data.txt are used in one of our simulation results. 
